...
insert  into `kpi_skill`(`skill_id`,`skill_category_id`,`skill_description`) values (1,1,'Networking'),(2,1,'Windows Server'),(3,1,'AD AAD'),(4,1,'Exchange'),(5,1,'Office 365'),(6,1,'Azure Bakup DPM'),(7,1,'zure VM Hyper-V'),(8,2,'EMS'),(9,2,'MDOP'),(10,2,'DLP AIP'),(11,2,'Win10 Ent'),(12,2,'Cloud App Security'),(13,2,'Intune');
...
insert  into `kpi_skill_matrix`(`id`,`month_year`,`skill_id`,`score`,`employee_id`,`date_created`,`status_code`) values (1,'2018',1,300,3,'2018-11-09 16:02:20','ACTIVE');
...
insert  into `kpi_week_plan`(`id`,`plan_date`,`task`,`estimated_duration`,`remark`,`status_code`,`assign_to`,`user_created`,`date_created`,`review_user`,`review_date`) values (1,'2018-10-27','sample task','5','sample remark','ACTIVE',0,1,'2018-10-27 12:26:37',0,NULL),(5,'2018-10-27','sample task','23:21 16:54','sample remark ','DEACTIVE',0,3,'2018-10-27 12:33:52',0,NULL),(6,'2018-10-27','sample task','23:21 16:54','sample remark ','ACTIVE',0,3,'2018-10-27 12:38:35',0,NULL),(7,'2018-10-25','ssss','04:54 TO 04:54','sadasd','ACTIVE',3,4,'2018-10-31 21:30:44',0,NULL),(8,'2018-11-08','sample','12:01 TO 15:04','sample remark','REVIEW',3,4,'2018-11-07 14:44:24',1,'2018-11-08 11:19:31am');
