...
insert  into `kpi_goal_objective`(`id`,`user_role`,`goal_ratio_id`,`objective`,`point`,`unit`,`measurement`) values (1,'JENGINEER',1,NULL,25,'%',NULL),(2,'JENGINEER',2,NULL,30,'%',NULL);
